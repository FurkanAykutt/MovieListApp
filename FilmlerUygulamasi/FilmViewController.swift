...
class FilmViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let k = kategori{
            ...
            filmListesi = Filmlerdao().filmleriAl(kategori_id: k.kategori_id!)
        }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let destinationVC = segue.destination as! FilmDetayViewController
        destinationVC.film = filmListesi[indeks!]
    }
}
